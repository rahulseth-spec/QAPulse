...
// FIX: Always use a named parameter with process.env.API_KEY for initialization.
const ai = new GoogleGenAI({ apiKey: process.env.API_KEY });

export const geminiService = {
  /**
   * Generates a concise summary of bottlenecks using Gemini.
   */
  ...
  /**
   * Suggests the load status based on capacity metrics.
   */
  ...
  /**
   * Generates a relevant success metric for a given goal description.
   */
